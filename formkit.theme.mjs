/**
  ...
  *
  * @checksum - a1f29a04038de80b4af920c930360c2bc20eb3f171a2bd460751eebd64b8aad6
  * @variables - radius=rounded-lg,accentColor=teal,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
