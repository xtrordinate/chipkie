...
class LoanChatController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'other_state'         => ['required', 'string', 'max:100'],
